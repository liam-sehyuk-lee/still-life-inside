...
label ending_normal:
    ...
    m "그래. 드디어 자유야! 이 붉은 빛이 눈부시지만, 이보다 더 좋을 순 없어! 이 모든 게... 진실이야."
    n "끝난 것... 같아. 정말로 끝난 걸까? 문을 열고 나오니... 아무것도 없는 텅 빈 공간 뿐이야."
    m "더 이상 의심하지 마. 넌 해냈어. 우린 이겼다고! 진실 따위는 중요하지 않아. 중요한 건... 우리가 함께라는 거야."
    ...
    "나는 '???'의 목소리에 기대어 겨우 한 발짝씩 나아갔다. 이 공허한 자유가 영원하기를 바라면서."
...
label ending_flickering_memory:
    ...
    "나는 그 의미를 알지 못했지만..."
    n "이건... 뭐지? 희미한 빛. 너무나... 그리운 기분이야. 누군가의 웃음소리... 따뜻한 손길..."
    m "괜찮아. 과거는 신경 쓰지 마. 이제 우리의 앞날만 생각하자. 함께라면 괜찮아! 저건... 놈들이 네 기억을 조작하는 거야. 환상이라고!"
    ...
    "나는 그렇게, 불완전한 평화 속에서 살아갔다. 영원히 엇나간 기억을 안고서."
...
label ending_uncertain_realization:
    ...
    scene black with fade
    n "문이 열렸다. 나는 탈출했지만... 이 승리가 진짜인지 확신할 수 없어. 내가 본 것은... 정말 전부였을까?"
    m "왜 그래? 우린 해냈어! 이제 자유야! 불안해하지 마! 더 이상 아무것도 우리를 쫓아오지 않아. 정말 괜찮아. 제발... 나를 믿어줘."
    n "하지만... 내가 본 것들이 정말 전부였을까? 왜 나는... 계속해서 무언가 놓친 것 같은 기분이 들까?"
    m "중요하지 않아! 중요한 건 우리가 여기 있다는 거야. 이제 아무것도 우리를 쫓아오지 않아. 정말 괜찮아."
    
    "나는 끊임없이 뒤를 돌아보았다. 문득, '???'의 목소리가 내 안에서 들려온 것이 아니라, 바로 내 옆에서 속삭이는 것처럼 느껴졌다."
    "언젠가 이 승리가 가짜였다는 것을, 내가 또 다른 감옥에 갇혔다는 것을 알게 될까 두려웠다."
...
label ending_partial_truth:
    ...
    m "봐. 드디어 알게 되었어! 모든 것은 놈들이 만든 가짜 감옥이었던 거야! 우리는... 이제 자유야!"
    n "우리가... 우리가 여기서 벗어났구나. 정말로... 이게 진짜 세상이었구나. 이 폐허가... 내 현실이었구나."
    m "그래. 이제야 제대로 알게 되었어. 이 모든 것은 놈들이 만든 게임이었어. 하지만 우리는 끝까지 살아남았지! 이제 놈들의 흔적은 모두 사라졌어. 오직 우리만 남았어."
    
    "나는 '???'의 말을 믿었다. 하지만 '우리'라는 단어가 묘하게 거슬렸다. 나는 문밖의 폐허를 바라보며, 문득 생각했다."
    "이게 진실이라고 해도... 정말 온전한 진실일까? '놈들'은 사라졌지만, '???'는 여전히 내 안에 남아 있다."
    "나는 또 다른 감옥에 갇힌 것은 아닐까. 어쩌면 가장 깊은 감옥에. `???`가 나를 위해, 이 모든 것을 설계한 것은 아닐까."
