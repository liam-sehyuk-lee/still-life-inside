...
label real_world_6:
    ...
    n "문 아래, 이 차가운 바닥 위에서... 나는 매일같이 괴물이 보낸 '암호'를 기다렸지."
    ...
    n "이건... 망상 속에서 섬뜩한 지시처럼 들렸던 그 문장이야."
    "사실은... 밖에서 문이 열리기만을 기다리던 엄마가 남긴, 그저 평범한 걱정의 메모였다."
    n "나는 그 평범한 온기마저 두려워하며, 스스로를 더 깊은 어둠 속으로 몰아넣었어."
...
label real_world_5:
    ...
    n "시선을 돌리자, 방 한쪽의 낡은 거울이 눈에 들어왔어."
    "망상 속에서 나를 비웃던 그 '눈'은..."
    "결국... 잠들지 못해 퀭하고, 초점을 잃은 채 흔들리던 내 눈이었다."
    n "거울 속의 나는, 유령처럼 말라 있었어. 나는 나 자신을 괴물이라 여기며, 스스로를 얼마나 갉아먹고 있었던 걸까."

    # 카메라가 서랍장 위의 약으로 조금 더 다가간다.
    show bg_reality_master at zoom_move(3.0, 0.99, 0.6, 1.0)

    n "그리고 그 옆... 내가 그토록 두려워하며 거부했던 약."
    "봉투에는 흐릿한 글씨로 이름이 적혀 있었다. '리스페리돈 1mg'."
    n "괴물이 건네는 독이 아니었어. 나를 현실에 붙들어주던... 마지막 끈이었다."
...
label real_world_4:
    ...
    n "그리고 저 의자 위의 작은 녹음기. 망상 속에서, 나는 저 기계에서 흘러나오는 목소리를 항상 '괴물'의 것이라고 믿었지."
    ...
    n "이제는 안다. 그건 괴물의 목소리가 아니었어. 겁에 질려 끊임없이 되뇌던... 바로 내 목소리였다."
    n "누군가에게 보내는 구조 신호가 아니었다. 그저 이 방 안에서 고립된 내가, 나에게 들려주던 처절한 고백이었다."
...
label real_world_3:
    ...
    n "망상 속에서 나를 쫓아오던 그 무겁던 발소리... 축축하게 끌리던 소리와 비릿한 냄새..."
    ...
    n "나는 무서웠어. 괴물에게서 도망치는 것이 아니었다."
    "현실의 나로부터 도망치고 싶었다. 문을 열었을 때 마주해야 할 내 모습이... 가장 무서웠던 거야."
...
label real_world_2:
    ...
    n "그리고 이곳. 이 작은 모니터 앞에서, 나는 세상과 싸우고 있다고 믿었지."
    ...
    n "수많은 닉네임, 수많은 댓글들... 나는 그 안에서 위로를 찾고 연대감을 느꼈다."
    "하지만 그곳엔 대화 같은 건 없었어. 처음부터 끝까지, 오직 나 혼자만의 처절한 독백만이 화면을 채우고 있었을 뿐이다."
...
label real_world_1:
    ...
    n "결국... 모든 것은 이 방 안에서 시작되고, 이 방 안에서 끝났어."
    "망상 속에서 내가 열고자 했던 그 '탈출구'는... 단 한 번도 열리지 않았던, 바로 이 방문이었다."
    "밖으로 나가지도, 괴물이 들어온 적도 없었다."
    "그저... 나는, 처음부터 여기 있었어. 스스로 만든 이 작은 감옥에서, 나 자신을 가둔 채로."
...
label true_ending:
    ...
    n "괴물을 피해 숨어들어온 이 방은, 사실 나를 지키던 마지막 요새였어."
    n "괴물에게서 도망치려 했던 모든 순간은, 사실 현실의 나로부터 도망치려던 발버둥이었다."
    n "이제는 알고 있다."
    
    "나는... 나를 가둔 것도, 나를 지킨 것도, 결국... 나였다는 것을 깨달았다."
